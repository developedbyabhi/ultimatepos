...
return [
    ...
    'sell_verify'=> 'verify Sell',
    'verify_sell' => 'Verify Sale',
    'unverify_sell' => 'Unverify Sale',
    'sell_verified_success' => 'Sale verified successfully',
    'sell_unverified_success' => 'Sale unverified successfully',
    'verified' => 'Verified',
    ...
    'min_order_total_for_rp_tooltip' => '<strong>The minimum amount the customer should spend to get reward points.</strong> <br><br> <strong>Example:</strong> If you set it as 100 then customer will get reward points only if their invoice total is greater than or equal to 100. If invoice total is 99 then they won\'t get any reward points. <br><br>You can set it as minimum 1.',
