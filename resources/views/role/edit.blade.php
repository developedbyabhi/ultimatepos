    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.verify', in_array('product.verify', $role_permissions), 
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            ...
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::radio('radio_option[so_view]', 'so.view_verified', in_array('so.view_verified', $role_permissions), 
